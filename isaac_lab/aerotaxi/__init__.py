...
for i in range(100):
    gym.register(
        ...
        kwargs={
            ...
            "rsl_rl_cfg_entry_point": f"{env_command.__name__}.env_10.grid_hiperparametros.cfg_files.ppo_random_command6_{i+1}_cfg:Command6PPORunnerCfg",
        },
    )

for i in range(100):
    gym.register(
        id=f"Isaac-Command7-Aerotaxi-RANDOM-{i+1}",
        entry_point="isaaclab.envs:ManagerBasedRLEnv",
        disable_env_checker=True,
        kwargs={
...
for i in range(100):
    gym.register(
        id=f"Isaac-Command8-Aerotaxi-RANDOM-{i+1}",
        entry_point="isaaclab.envs:ManagerBasedRLEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{env_command.__name__}.env_12.env:UAVEnvCfg",
            "rsl_rl_cfg_entry_point": f"{env_command.__name__}.env_12.grid_hiperparametros.cfg_files.ppo_random_command8_{i+1}_cfg:Command8PPORunnerCfg",
        },
    )

for i in range(100):
    gym.register(
        id=f"Isaac-Command9-Aerotaxi-RANDOM-{i+1}",
        entry_point="isaaclab.envs:ManagerBasedRLEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{env_command.__name__}.env_13.env:UAVEnvCfg",
            "rsl_rl_cfg_entry_point": f"{env_command.__name__}.env_13.grid_hiperparametros.cfg_files.ppo_random_command9_{i+1}_cfg:Command9PPORunnerCfg",
        },
    )

for i in range(100):
    gym.register(
        id=f"Isaac-Command10-Aerotaxi-RANDOM-{i+1}",
        entry_point="isaaclab.envs:ManagerBasedRLEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{env_command.__name__}.env_14.env:UAVEnvCfg",
            "rsl_rl_cfg_entry_point": f"{env_command.__name__}.env_14.grid_hiperparametros.cfg_files.ppo_random_command10_{i+1}_cfg:Command10PPORunnerCfg",
        },
    )

for i in range(100):
    gym.register(
        id=f"Isaac-Command11-Aerotaxi-RANDOM-{i+1}",
        entry_point="isaaclab.envs:ManagerBasedRLEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{env_command.__name__}.env_15.env:UAVEnvCfg",
            "rsl_rl_cfg_entry_point": f"{env_command.__name__}.env_15.grid_hiperparametros.cfg_files.ppo_random_command11_{i+1}_cfg:Command11PPORunnerCfg",
        },
    )

for i in range(100):
    gym.register(
        id=f"Isaac-Command12-Aerotaxi-RANDOM-{i+1}",
        entry_point="isaaclab.envs:ManagerBasedRLEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{env_command.__name__}.env_16.env:UAVEnvCfg",
            "rsl_rl_cfg_entry_point": f"{env_command.__name__}.env_16.grid_hiperparametros.cfg_files.ppo_random_command12_{i+1}_cfg:Command12PPORunnerCfg",
        },
    )

for i in range(100):
    gym.register(
        id=f"Isaac-Command13-Aerotaxi-RANDOM-{i+1}",
        entry_point="isaaclab.envs:ManagerBasedRLEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{env_command.__name__}.env_17.env:UAVEnvCfg",
            "rsl_rl_cfg_entry_point": f"{env_command.__name__}.env_17.grid_hiperparametros.cfg_files.ppo_random_command13_{i+1}_cfg:Command13PPORunnerCfg",
        },
    )

for i in range(100):
    gym.register(
        id=f"Isaac-Command14-Aerotaxi-RANDOM-{i+1}",
        entry_point="isaaclab.envs:ManagerBasedRLEnv",
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": f"{env_command.__name__}.env_18.env:UAVEnvCfg",
            "rsl_rl_cfg_entry_point": f"{env_command.__name__}.env_18.grid_hiperparametros.cfg_files.ppo_random_command14_{i+1}_cfg:Command14PPORunnerCfg",
        },
    )