...
function SetJLS(wp1,wp2)
    ...
    %   t1 pos1 vel1 acel1
    %   t2 pos2 vel2 acel2
    % obtiene jerk1, snap1 y crackle1 para ejecutar dicho movimiento
...
function PlotVel(obj)
    plot3(obj.pos(1), obj.pos(2), obj.pos(3),'.', ...
        'LineWidth', 2, ...
        'Color','black')
    quiver3(obj.pos(1), obj.pos(2), obj.pos(3), ...
            obj.vel(1), obj.vel(2), obj.vel(3), ...
            'LineWidth', 2, ...
            'Color','black','MaxHeadSize',3)
