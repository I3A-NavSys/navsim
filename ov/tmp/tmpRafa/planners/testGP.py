...
from planners.GridPlanner import GridPlanner
...
# print("-------------------")
# route = gp.GetRoute((2, 4, 'X', 5), (8, 4, 'X', -1))
# route = gp.GetRoute((1, 4, 'X', 4), (8, 4, 'X', -1))
# print(route)
# print(gp.AreThereConflicts(route))
# gp.ReserveNodes(route)
