...
class Aerotaxi(BehaviorScript):
    ...
    def on_init(self):
        ...
        fp = FlightPlan()
        # Build the waypoints
        fp.set_waypoint(label="wp01", time=0, pos=[-78.03401, -193.00378, 38.95842], heading=[-1,0])
        fp.set_waypoint(label="wp02", time=15, pos=[-78, -193, 60])
        fp.set_waypoint(label="wp03", time=45, pos=[-175, -193, 60.0], heading=[0, -1])
        fp.set_waypoint(label="wp04", time=65, pos=[-175, -193, 15.0])
        fp.set_waypoint(label="wp05", time=80, pos=[-175, -223.5, 15.0])
        fp.set_waypoint(label="wp06", time=120, pos=[90, -223.5, 15.0])
