...
class CubeBehavior(BehaviorScript):
    def on_play(self):
        ...
        CUBE_EVENT = carb.events.type_from_string("omni.stream_event_example.CUBE_EVENT")
        ...
        self.cube_event_push_subs = self.bus.create_subscription_to_push_by_type(CUBE_EVENT, self.cube_event_callback)
    ...
    def cube_event_callback(self, event):
    ...
    def on_stop(self):
        ...
        self.cube_event_push_subs = None
