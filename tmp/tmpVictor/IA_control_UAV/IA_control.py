...
class Aerotaxi(BehaviorScript):
    ...
    def on_init(self):
        ...
        # BEST:
        policy_path = f"{project_root_path}/tmp/tmpVictor/IA_control_UAV/policy.pt"
    ...
    def servo_control(self):
        ...
        self.w_rotor_NW = actions[0].item()
        self.w_rotor_NE = actions[1].item()
        self.w_rotor_SW = actions[2].item()
        self.w_rotor_SE = actions[3].item()
    ...
    def tracked_data_to_csv(self):
        ...
        path = project_root_path + "/sims/exported_data" + f"/{uav_id}_{self.completed_fps}_IA_control.csv"
