...
class UAM_minidrone(BehaviorScript):
    ...
    def on_init(self):
        ...
        prim_paths = ["/World/UAM_aerotaxi_rpv", "/World/UAM_aerotaxi_rpv", "/World/UAM_aerotaxi_rpv", "/World/UAM_aerotaxi_rpv", "/World/UAM_aerotaxi_rpv"]
    ...
    def imu(self):
        ...
        # Print imu data
        print("RPV")
        print("step,position_x,position_y,position_z,rotation_x,rotation_y,rotation_z,linear_velocity_x,linear_velocity_y,linear_velocity_z,angular_velocity_x,angular_velocity_y,angular_velocity_z")
        print(f"{self.steps}, {self.body_link_pos[0]}, {self.body_link_pos[1]}, {self.body_link_pos[2]}, {self.roll}, {self.pitch}, {self.yaw}, {self.body_link_lin[0]}, {self.body_link_lin[1]}, {self.body_link_lin[2]}, {self.body_link_ang[0]}, {self.body_link_ang[1]}, {self.body_link_ang[2]}")
