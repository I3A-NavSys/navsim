"""
plot_latency_cdf_sequential_1.py — Genera la CDF de latencias del benchmark sequential de 500 UAVs.

Lee el fichero benchmark_realtime_sequential_conflicts_output_1.txt
Genera la CDF para el de 500 UAVs.

Uso:
    python plot_latency_cdf_sequential_1.py
"""
...
# Config
# ---------------------------------------------------------------------------
INPUT_FILE  = Path(__file__).parent / "benchmark_realtime_sequential_conflicts_output_1.txt"
OUTPUT_FILE = Path(__file__).parent / "latency_cdf_sequential_1.pdf"
...
ax.set_title("Total Processing Time CDF \u2014 Sequential Benchmark (500 UAVs)", fontsize=12)
