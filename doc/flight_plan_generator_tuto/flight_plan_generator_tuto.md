...
flight plan, you must create a set of waypoints which will be ordered in time and thed interconnected.  
...
- Fly over: wheter this waypoint is mandatory to trough or not
- WaypointID: an identifier to the waypoint  
...
Finally, click on *REFRESH* button at the top of the extensions, select an UAV among the options, click on *PLAY*
